...
export const PLACEHOLDER_NPCS: NPC[] = [
  {
    ...
    backstory: '九天鬼谋之一，自幼便被当作棋手培养。他走遍大江南北，只为寻找能终结乱世的契机。外表虽是书生，实则胸藏百万兵甲。多年前曾因计谋失误导致挚友惨死，从此发誓不再让感情影响决断。',
    lifeGoal: '寻找《九天兵鉴》。',
    relationships: [],
    currentMood: '深沉',
    status: 'Normal',
  ...
  },
  {
    ...
    backstory: '出身名门，却不爱红装爱武装。因为仰慕李复的才华而离家出走，一路追随。她不仅厨艺了得，一手暗器功夫更是深不可测。表面上是温顺的侍女，实则是为了保护李复不被仇家暗杀。',
    lifeGoal: '与李复归隐山林。',
    relationships: [],
    currentMood: '忧虑',
    status: 'Normal',
